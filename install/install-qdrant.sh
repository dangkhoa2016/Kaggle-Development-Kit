...
if [ -z "$QNP_SOURCE_CANONICAL_SHA256" ] \
   && [ "$QNP_SOURCE_COMMIT" = "464cb5dbc1117a8a8a6472d76a10c5e329021156" ]; then
    QNP_SOURCE_CANONICAL_SHA256="2434ea7b9d0455599f31d61080f90afc209d92eed950b0042941507b537e5413"
fi
