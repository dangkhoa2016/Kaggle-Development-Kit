...
if [ -n "$qnp_source_name" ] && [ -f "$qnp_source/VERSION" ]; then
  ...
  elif [ "$qnp_commit_meta" != "${QNP_SOURCE_COMMIT:-464cb5dbc1117a8a8a6472d76a10c5e329021156}" ]; then
    fail QNP "pin mismatch: expected=${QNP_SOURCE_COMMIT:-464cb5dbc1117a8a8a6472d76a10c5e329021156} metadata=$qnp_commit_meta"
  ...
  elif [ "$qnp_head_actual" != "${QNP_SOURCE_COMMIT:-464cb5dbc1117a8a8a6472d76a10c5e329021156}" ]; then
    fail QNP "pin mismatch: expected=${QNP_SOURCE_COMMIT:-464cb5dbc1117a8a8a6472d76a10c5e329021156} checkout HEAD=$qnp_head_actual"
  else
