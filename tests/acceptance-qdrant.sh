...
[ "$(tr -d '[:space:]' < "$SYSTEM/qdrant/qnp/1.0.0-464cb5dbc111/VERSION")" = '1.0.0' ]
grep -qx 'commit=464cb5dbc1117a8a8a6472d76a10c5e329021156' "$SYSTEM/qdrant/qnp/1.0.0-464cb5dbc111/.qnp-source-meta"
...
qnp_release=1.0.0
qnp_commit=464cb5dbc1117a8a8a6472d76a10c5e329021156
