...
mkdir -p "$SYSTEM/qdrant/instances/1.18.3/qdrant-1.18.3" \
         ...
         "$SYSTEM/qdrant/qnp/1.0.0-464cb5dbc111"
cat > "$CFG" <<'CFG'
INSTALL_QDRANT=1
...
printf '1.0.0\n' > "$SYSTEM/qdrant/qnp/1.0.0-464cb5dbc111/VERSION"
cat > "$SYSTEM/qdrant/qnp/1.0.0-464cb5dbc111/.qnp-source-meta" <<'META'
release=1.0.0
commit=464cb5dbc1117a8a8a6472d76a10c5e329021156
